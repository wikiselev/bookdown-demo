...
```{r Search0, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(knitr)
...
```{r Search2, echo = FALSE, out.width = '80%', fig.cap="scfind can be used to search large collection of scRNA-seq data by a list of gene IDs."}
...
```{r Search6, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
