...
```{r process-raw0, include=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo())}
library(knitr)
...
__Answer__
```{bash process-raw6, eval=TRUE, include=FALSE}
