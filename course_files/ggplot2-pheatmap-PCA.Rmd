...
```{r ggplot2-pheatmap-PCA0, echo=FALSE}
library(knitr)
...
```{R ggplot2-pheatmap-PCA1, eval=TRUE, message=FALSE}
library(ggplot2)
library(tidyverse)
set.seed(1)
...
```{R ggplot2-pheatmap-PCA2, eval=TRUE}
...
```{R ggplot2-pheatmap-PCA3, eval=TRUE}
...
```{R ggplot2-pheatmap-PCA4, eval=TRUE}
...
```{R ggplot2-pheatmap-PCA5, eval=TRUE, message=FALSE}
library(pheatmap)
set.seed(2)
...
```{R ggplot2-pheatmap-PCA6, eval=TRUE}
...
```{R ggplot2-pheatmap-PCA7,eval=TRUE, message=FALSE}
library(ggfortify)
...
```{R ggplot2-pheatmap-PCA8,eval=TRUE}
set.seed(1)
counts <- as.data.frame(matrix(rpois(100, lambda = 10), ncol=10, nrow=10))
