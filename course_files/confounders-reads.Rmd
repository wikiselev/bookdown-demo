...
```{r confounders-read0, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r confounders-read2, fig.cap = "PC correlation with the number of detected genes", fig.asp=1}
...
```{r confounders-read3, fig.cap = "Explanatory variables"}
