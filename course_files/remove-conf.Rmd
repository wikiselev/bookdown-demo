...
```{r remove-conf4, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r remove-conf5, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
