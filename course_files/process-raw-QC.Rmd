...
```{r Raw-QC0, include=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo())}
library(knitr)
...
```{bash Raw-QC2, eval=FALSE, collapse=TRUE}
fastqc -h
```
...
```{bash Raw-QC3, eval=FALSE, echo = TRUE}
