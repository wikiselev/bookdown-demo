...
```{r umis0, echo=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo())}
library(knitr)
opts_chunk$set(fig.align = "center", echo=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo()))
```
...
```{r umis1, out.width = '90%', fig.cap="UMI sequencing protocol"}
...
```{r umis2, out.width = '90%', fig.cap="UMI sequencing reads, red lightning bolts represent different fragmentation locations"}
...
```{r umis3, out.width = '90%', fig.cap="Potential Errors in UMIs"}
...
```{r umis4, out.width = '60%', fig.cap="Per gene amplification rate"}
...
```{r umis6, echo=TRUE, include=TRUE}
