...
```{r Intro-TabulaMuris0, echo=FALSE}
library(knitr)
...
```{bash Intro-TabulaMuris1, message=FALSE, warning=FALSE, results='hide'}
...
```{bash Intro-TabulaMuris2, message=FALSE, warning=FALSE, results='hide'}
...
```{r Intro-TabulaMuris15}
head(cellbarcodes)
```

```{r Intro-TabulaMuris16}
...
__Answer__
```{r Intro-TabulaMuris22, echo=FALSE, eval=TRUE}
...
__Answer__
```{r Intro-TabulaMuris26, echo=FALSE, eval=FALSE}
dim(all_molecules)[2]
```
