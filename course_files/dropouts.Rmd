...
```{r dropout6, echo=FALSE, fig.width = 8.5, fig.height = 6}
plot(
...
```{r dropout7, fig.width = 7, fig.height = 6}
...
```{r dropout9, echo=FALSE, fig.width = 8.5, fig.height = 6}
length(HVG_genes)
```
#### High Dropout Genes
...
```{r dropout10, fig.width = 8.5, fig.height = 6, echo=TRUE}
K <- 49
...
```{r dropout12, fig.width = 7, fig.height = 6}
...
```{r dropout13, fig.width=8, fig.height=5}
...
```{r dropout14, echo=FALSE, fig.width = 8.5, fig.height = 6}
nrow(DropFS)
```
...
```{r dropout16, fig.width=7, fig.height=6}
...
```{r dropout18, fig.width = 7, fig.height = 10}
...
```{r dropout20, eval=FALSE, include=FALSE, fig.width = 7, fig.height = 10}
M3DropExpressionHeatmap(
    HVG_genes,
    expr_matrix,
    cell_labels = celltype_labs
...
```{r dropout21, eval=FALSE, include=FALSE, fig.width = 7, fig.height = 10}
M3DropExpressionHeatmap(
    Cor_genes,
    expr_matrix,
    cell_labels = celltype_labs
...
```{r dropout22, eval=FALSE, include=FALSE, fig.width = 7, fig.height = 10}
M3DropExpressionHeatmap(
    PCA_genes,
    expr_matrix,
    cell_labels = celltype_labs
...
```{r dropout23, eval=FALSE, include=FALSE, fig.width = 7, fig.height = 10}
M3DropExpressionHeatmap(
    PCA_genes2,
    expr_matrix,
    cell_labels = celltype_labs
...
```{r dropout24, eval=FALSE, include=FALSE}
