...
```{r intro-to-R0, echo=FALSE}
library(knitr)
opts_chunk$set(out.width='90%', fig.align = 'center', cache=TRUE, cache.extra = list(R.version, sessionInfo()))
```
