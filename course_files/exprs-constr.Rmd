...
```{r exprs-constr0, echo=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo())}
library(knitr)
...
```{r exprs-constr2, out.width = '90%', fig.cap="Example of the total number of reads mapped to each cell."}
...
```{r exprs-constr3, out.width = '90%', fig.cap="Example of the 3' bias in the read coverage."}
