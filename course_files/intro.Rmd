...
```{r intro0, echo=FALSE, cache=TRUE, cache.extra = list(R.version, sessionInfo())}
library(knitr)
...
```{r intro1, out.width = '90%', fig.cap="Single cell sequencing (taken from Wikipedia)"}
...
```{r intro2, out.width = '65%', fig.cap="Flowchart of the scRNA-seq analysis"}
