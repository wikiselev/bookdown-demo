...
```{r remove-conf-read0, echo=FALSE}
library(knitr)
...
```{r remove-conf-read5, eval = TRUE, echo = FALSE, message=FALSE, warning=FALSE}
...
```{r remove-conf-read8, echo=FALSE}
...
```{r remove-conf-read12, message = FALSE}
...
```{r remove-conf-read13, message = FALSE}
require("reshape2")
...
```{r remove-conf-read14, echo=FALSE}
sessionInfo()
```
