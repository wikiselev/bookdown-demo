...
Another method proposed by [Brennecke et al.](http://www.nature.com/nmeth/journal/v10/n11/full/nmeth.2645.html) 
dentifies genes with significant variation above technical noise as measured by spike-ins. However, we find using all genes as
spike-ins often performs better than using a relatively small number of spike-ins (only 9 ERCCs were detected in this dataset). 
...
between these two variables for the "spike-ins" then a chi-square test is used to find genes
...
```
In the figure above the red curve
